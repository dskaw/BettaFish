...
class Settings(BaseSettings):
    ...
    INSIGHT_ENGINE_CLI_COMMAND: Optional[str] = Field(None, description="Insight Agent CLI 命令模板，支持通过命令行方式调用模型，允许使用 {model} 占位符。")
    ...
    MEDIA_ENGINE_CLI_COMMAND: Optional[str] = Field(None, description="Media Agent CLI 命令模板，配置后可通过 Codex 等命令行工具调用模型。")
    ...
    MINDSPIDER_CLI_COMMAND: Optional[str] = Field(None, description="MindSpider CLI 命令模板，可使用 {model} 占位符。")
    ...
    QUERY_ENGINE_CLI_COMMAND: Optional[str] = Field(None, description="Query Agent CLI 命令模板，用于命令行调用模型。")
    ...
    REPORT_ENGINE_CLI_COMMAND: Optional[str] = Field(None, description="Report Agent CLI 命令模板，可包含 {model} 占位符。")
    ...
    FORUM_HOST_CLI_COMMAND: Optional[str] = Field(None, description="Forum Host CLI 命令模板。")
    ...
    KEYWORD_OPTIMIZER_CLI_COMMAND: Optional[str] = Field(None, description="Keyword Optimizer CLI 命令模板，可通过命令行方式调用模型。")
